...
The normalization core of [Observatory]. It turns translation segments into
...
itself. (See the repo's root README for the wider system this crate is the
foundation of, and `docs/DECISIONS.md` for the reasoning record.)
